...
// Postgres tra NUMERIC/DECIMAL thanh CHUOI de khong mat do chinh xac.
// Du an co 51 cot DECIMAL (gia, tong don, phi ship). Neu de nguyen chuoi thi
// price.toFixed() se loi va subtotal + shipping_fee se NOI CHUOI thay vi cong.
types.setTypeParser(1700, (v) => (v === null ? null : parseFloat(v)))

// DATE: pg tra ve doi tuong Date, mysql2 tra ve chuoi 'YYYY-MM-DD'.
// Giu nguyen chuoi de code cu dinh dang ngay khong doi.
